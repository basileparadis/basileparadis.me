      ...
      <SinglePageElement reversed>
        <div slot="content">
          ...
          <p>
            ...
            <a href="https://www.storefrontui.io/">StorefrontUi</a>. Backend uses Express.js to query the Google Spreadsheet API.
          </p>
          <br />
          <div class="level">
    ...
    <div id="contact" class="subject contact">
      <SinglePageElement>
        <div slot="content">
          ...
          <br />
          <p class="subtitle">Let's get in touch! Leave me a message and I'll reply as soon as possible</p>
